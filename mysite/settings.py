...
ALLOWED_HOSTS = ['174.138.28.26', '104.217.253.15', '174.138.28.26',
...
DATABASES = {
    'default': {
        ...
        'PORT': '3306',
        'OPTIONS': {
            'init_command': 'SET storage_engine=INNODB; ALTER DATABASE django CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci',
        },
    }
}
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_FILTER_BACKENDS': ('rest_framework_filters.backends.RestFrameworkFilterBackend', 'rest_framework.filters.OrderingFilter'),
